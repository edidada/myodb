...
#ifndef MYODB_ODB_HXX
#define MYODB_ODB_HXX
...
namespace odb
{
  ...
  struct query_columns< ::student, id_mysql, A >
  {
    ...
    static const likes_type_ likes;
    ...
    static const sscholl_type_ sscholl;
  ...
  template <typename A>
  const typename query_columns< ::student, id_mysql, A >::likes_type_
  query_columns< ::student, id_mysql, A >::
  likes (A::table_name, "`likes`", 0);

  template <typename A>
  const typename query_columns< ::student, id_mysql, A >::sscholl_type_
  query_columns< ::student, id_mysql, A >::
  sscholl (A::table_name, "`sscholl`", 0);
    ...
    public access::object_traits< ::student >
  {
    ...
    struct image_type
    {
      ...
      // likes
      //
      details::buffer likes_value;
      unsigned long likes_size;
      my_bool likes_null;

      // sscholl
      //
      details::buffer sscholl_value;
      unsigned long sscholl_size;
      my_bool sscholl_null;
