...
namespace odb
{
        ...
        my_bool* t)
  {
    ...
    if (t[2UL])
    {
      i.likes_value.capacity (i.likes_size);
      grew = true;
    }
    ...
    if (t[3UL])
    {
      i.sscholl_value.capacity (i.sscholl_size);
      grew = true;
    }
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    b[n].buffer_type = MYSQL_TYPE_STRING;
    b[n].buffer = i.likes_value.data ();
    b[n].buffer_length = static_cast<unsigned long> (
      i.likes_value.capacity ());
    b[n].length = &i.likes_size;
    b[n].is_null = &i.likes_null;
    n++;

    // sscholl
    //
    b[n].buffer_type = MYSQL_TYPE_STRING;
    b[n].buffer = i.sscholl_value.data ();
    b[n].buffer_length = static_cast<unsigned long> (
      i.sscholl_value.capacity ());
    b[n].length = &i.sscholl_size;
    b[n].is_null = &i.sscholl_null;
    n++;
        ...
        mysql::statement_kind sk)
  {
    ...
    //
    {
      ...
      bool is_null (true);
      std::size_t size (0);
      std::size_t cap (i.likes_value.capacity ());
      mysql::value_traits<
        ...
        is_null,
        v);
      i.likes_null = is_null;
      i.likes_size = static_cast<unsigned long> (size);
      grew = grew || (cap != i.likes_value.capacity ());
    }
    ...
    //
    {
      ...
      bool is_null (false);
      std::size_t size (0);
      std::size_t cap (i.sscholl_value.capacity ());
      mysql::value_traits<
          ::std::string,
          mysql::id_string >::set_image (
        i.sscholl_value,
        ...
        is_null,
        v);
      i.sscholl_null = is_null;
      i.sscholl_size = static_cast<unsigned long> (size);
      grew = grew || (cap != i.sscholl_value.capacity ());
    }
